...
public class GameFlowManager {
    ...
    public static void startGameFlow(RuleConfig config) {
        ...
        switch (ruleConfig.getGameMode()) {
            ...
            case RANDOM:
                ...
                new BattleUI(game, ruleConfig, randomTeam1, randomTeam2);
    ...
    public static void handleWeaponAndArenaSelected(String weapon, String arena) {
        ...
        if (ruleConfig.getGameMode() == RuleConfig.GameMode.SURVIVAL) {
            ...
            new BattleUI(game, ruleConfig, player1Team, player2Team);
        }
    }

    public static void handleSurvivalPerkSelected() {
        Game game = new Game(ruleConfig, player1Team, null);
        SurvivalPerk selectedPerk = game.chooseSurvivalPerk();
        new BattleUI(game, ruleConfig, player1Team, null);
