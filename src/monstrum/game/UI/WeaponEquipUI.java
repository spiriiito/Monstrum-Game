...
public class WeaponEquipUI extends JFrame {
    ...
    private Team team2;
    private final Border GLOW_BORDER = BorderFactory.createLineBorder(new Color(255, 105, 255), 4); // Pink glow
    ...
    public WeaponEquipUI(List<Monster> team, String playerLabel, String selectedWeapon, RuleConfig ruleConfig, Team player1Team, Team player2Team, boolean isPlayerOne, Game game) {
        ...
        if (playerLabel != null) {
            ...
            topPanel.add(Box.createVerticalStrut(15)); // optional: preserve spacing
        }
        ...
        continueButton.addActionListener(e -> {
            if (selectedMonster != null) {
                ...
                if (ruleConfig.getGameMode() == RuleConfig.GameMode.PLAYER_VS_AI) {
                    ...
                    Game battleGame = new Game(ruleConfig, player1Team, enemyTeam);
                    SwingUtilities.invokeLater(() ->
                            new BattleUI(battleGame, ruleConfig, battleGame.getPlayerTeam(), battleGame.getEnemyTeam()));
                }
